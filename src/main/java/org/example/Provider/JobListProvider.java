...
public class JobListProvider {
    ...
    public static class NamedJobList {
        ...
        public NamedJobList(String name, List<Job> jobs) {
            this.name = name;
            this.jobs = jobs;
        }
    }
    ...
    public static NamedJobList getSmallJobList() {
        ...
        return new NamedJobList("Kleine Liste", Arrays.asList(
            new Job(0, 100, 150),
            new Job(1, 120, 130),
            new Job(2, 90, 110)
        ));
    ...
    public static NamedJobList getMediumJobList() {
        ...
        return new NamedJobList("Mittlere Liste", Arrays.asList(
            new Job(0, 200, 300),
            new Job(1, 250, 350),
            new Job(2, 220, 330),
            new Job(3, 240, 310)
    ...
    public static NamedJobList getLargeJobList() {
        ...
        return new NamedJobList("Große Liste", Arrays.asList(
            new Job(0, 400, 500),
            new Job(1, 450, 550),
            new Job(2, 420, 530),
            new Job(3, 440, 510),
    ...
    public static NamedJobList getAllSameSizeList() {
        ...
        return new NamedJobList("Alle Jobs gleich groß (100x)", jobs);
    }
    ...
    public static NamedJobList getDuplicateJobsList() {
        ...
        return new NamedJobList("Doppelte Jobs", Arrays.asList(
            new Job(0, 200, 200),
            new Job(1, 200, 200),
            new Job(2, 200, 200),
            new Job(3, 200, 200),
    ...
    public static NamedJobList getTooLargeJobsList() {
        ...
        return new NamedJobList("Zu große Jobs", Arrays.asList(
            new Job(0, 2000, 2000),
            new Job(1, 963, 700),
            new Job(2, 1200, 650),
            new Job(3, 964, 651)
    ...
    public static NamedJobList getVerySmallJobsList() {
        ...
        return new NamedJobList("Sehr kleine Jobs", Arrays.asList(
            new Job(0, 1, 1),
            new Job(1, 2, 2),
            new Job(2, 3, 3),
            new Job(3, 4, 4),
    ...
    public static NamedJobList getMixedExtremeList() {
        ...
        return new NamedJobList("Gemischte Extreme", Arrays.asList(
    ...
    public static NamedJobList getSingleJobFitsExactly() {
        ...
        return new NamedJobList("Ein Job passt exakt", Arrays.asList(
            new Job(0, 963, 650)
        ));
    }
    ...
    public static NamedJobList getSingleJobTooLarge() {
        ...
        return new NamedJobList("Ein Job zu groß", Arrays.asList(
            new Job(0, 2000, 2000)
        ));
    }
    ...
    public static NamedJobList getManyTinyJobs() {
        ...
        return new NamedJobList("Viele winzige Jobs (100x 5x5)", jobs);
    }
    ...
    public static NamedJobList getAlternatingSizesList() {
        ...
        return new NamedJobList("Abwechselnd große und kleine Jobs", Arrays.asList(
            new Job(0, 400, 500),
            new Job(1, 5, 5),
            new Job(2, 450, 550),
            new Job(3, 10, 10),
    ...
    public static NamedJobList getDecimalJobsList() {
        ...
        return new NamedJobList("Jobs mit Kommazahlen", jobs);
    }
